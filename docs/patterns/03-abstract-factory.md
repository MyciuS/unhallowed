...
- **Code:** `src/Unhallowed.Core/Rooms/ (to add)`
...
An IBiomeFactory per floor theme (Basement, Caves, Depths) producing a matching family of enemies, tiles, props and pickups.
...
![before](../uml/03-abstract-factory-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/03-abstract-factory-after.png)
...
```csharp
// src/Unhallowed.Core/Rooms/ (to add)
```
