...
- **Code:** `src/Unhallowed.Core/ (to add)`
...
A small item-synergy language, e.g. `ON_HIT: burn(3) AND slow(0.5)`, parsed into an expression tree evaluated at runtime.
...
![before](../uml/15-interpreter-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/15-interpreter-after.png)
