...
- **Code:** `src/Unhallowed.Core/AI/`
- **Demo:** `dotnet run --project src/Unhallowed.PatternDemos -- strategy`
- **Status:** implemented
...
Enemy movement swapped at runtime: Chaser, Wanderer, Charger, Stationary. One Enemy class, no type switch.
...
![before](../uml/21-strategy-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/21-strategy-after.png)
...
```
dotnet run --project src/Unhallowed.PatternDemos -- strategy
```
