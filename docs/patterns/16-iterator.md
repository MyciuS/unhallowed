...
A RoomIterator walking the dungeon graph breadth-first for minimap reveal and depth-first for a seeded run preview.
...
![before](../uml/16-iterator-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/16-iterator-after.png)
