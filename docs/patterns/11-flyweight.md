...
A tile flyweight factory sharing intrinsic tile data (visual, collision, cost) across thousands of floor tiles.
...
![before](../uml/11-flyweight-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/11-flyweight-after.png)
