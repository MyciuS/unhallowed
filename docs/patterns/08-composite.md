...
- **Code:** `src/Unhallowed.Client/Rendering/ (to add)`
...
A HUD element tree where panels contain bars, labels and icons, and drawing the root draws everything.
...
![before](../uml/08-composite-before.png)

_Export from MagicDraw (requirement 14)._

## 4. UML class diagram - AFTER

![after](../uml/08-composite-after.png)
...
```csharp
// src/Unhallowed.Client/Rendering/ (to add)
```
